...
internal sealed class Mod : MelonMod
{
    ...
    public override void OnUpdate()
    {
        ...
        {
            TestAffliction test = new TestAffliction("TEST", "Test Affliction Description", AfflictionBodyArea.Neck, "ico_injury_majorBruising", "Test Affliction", false, false, 1, false, false, [Tuple.Create("GEAR_Bandage", 1, 1)], []);
            test.Start();
        }
    }
}